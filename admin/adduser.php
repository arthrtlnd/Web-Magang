...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (strlen($nrp) < 6) { // Fleksibel jika NRP lebih panjang
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/adduser.css"> <!-- CSS spesifik -->
    <style>
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="nrp" name="nrp" required 
                           ...
                           pattern="[0-9]{6,}"
                           value="<?php echo isset($_POST['nrp']) ? $_POST['nrp'] : ''; ?>">
